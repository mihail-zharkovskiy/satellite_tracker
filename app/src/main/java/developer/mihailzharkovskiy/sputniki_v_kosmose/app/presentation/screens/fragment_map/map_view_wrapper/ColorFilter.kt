...
/**
 * textview.background.colorFilter = myColorFilter()
 * подробнее о реализации: https://medium.com/squaer-corner-blog/welcomr-to-the-color-matrix-64d112e3f43d
 * **/
internal fun MapViewWrapper.getColorFilter(colorFiltr: String = "#1D3245"): ColorMatrixColorFilter {
    val inversMatrix = ColorMatrix(
        floatArrayOf(
            -1f, 0f, 0f, 0f, 255f,
            0f, -1f, 0f, 0f, 255f,
            0f, 0f, -1f, 0f, 255f,
    ...
    val myColor = Color.parseColor(colorFiltr)
    ...
    myMatrix.preConcat(inversMatrix)
